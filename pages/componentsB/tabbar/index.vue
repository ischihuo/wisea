		...
		<view class="w-demo">
			<view class="w-config-wrap">
				...
				<view class="w-config-item">
					...
					<w-subsection vibrateShort :list="['显示', '隐藏']" @change="showChange"></w-subsection>
				</view>
				<view class="w-config-item">
					<view class="w-item-title">凸起按钮</view>
					<w-subsection vibrateShort :list="['显示', '隐藏']" @change="minButtonChange"></w-subsection>
				</view>
				<view class="w-config-item">
					<view class="w-item-title">背景色</view>
					<w-subsection vibrateShort :list="['#ffffff', '#1f1f1d']" @change="bgColorChange"></w-subsection>
				</view>
				<view class="w-config-item">
					<view class="w-item-title">顶部边框</view>
					<w-subsection vibrateShort :list="['显示', '隐藏']" @change="borderTopChange"></w-subsection>
				</view>
				<view class="w-config-item">
					<view class="w-item-title">提示角标</view>
					<w-subsection vibrateShort :list="['显示', '隐藏']" @change="badgeChange"></w-subsection>
				</view>
			</view>
		</view>
		<w-tabbar
