	...
	<view class="w-demo">
		<view class="w-demo-wrap">
			...
			<view class="w-demo-area">
				<view class="w-demo-result-line">{{ input ? input : 'Picker值' }}</view>
				<w-picker
					:mode="mode"
		...
		<view class="w-config-wrap">
			...
			<view class="w-config-item">
				<view class="w-item-title">Picker开关</view>
				<w-subsection vibrateShort :current="status" :list="['显示', '隐藏']" @change="statusChange"></w-subsection>
			</view>
			<view class="w-config-item">
				<view class="w-item-title">模式选择</view>
				<w-subsection vibrateShort :list="['单列', '多列', '时间', '地区']" @change="modeChange"></w-subsection>
			</view>
			<view class="w-config-item">
				<view class="w-item-title">默认时间</view>
				<w-subsection vibrateShort :list="['2019-12-11 20:15:35', '2020-02-05 13:09:42']" @change="defaultTimeChange"></w-subsection>
			</view>
			<view class="w-config-item">
				<view class="w-item-title">显示时分秒</view>
				<w-subsection vibrateShort :list="['显示', '隐藏']" @change="minSecChange"></w-subsection>
			</view>
			<view class="w-config-item">
				<view class="w-item-title">默认地区</view>
				<w-subsection vibrateShort :list="['广东-深圳-宝安', '海南-三亚-海棠']" @change="defaultRegionChange"></w-subsection>
			</view>
		</view>
	</view>
</template>
