	...
	<view class="w-wrap">
		<view class="meituan">
			...
			<view class="tips">
				...
				<view class="explain w-line-1">满8.1元可用、限最新版本客户端使用</view>
				<view class="rule w-line-1" @tap="xxx122">
					<text>使用规则</text>
					<w-icon name="arrow-right" color="" :size="20" @click=""></w-icon>
				</view>
			</view>
		</view>
		<view class="jingdong">
			...
			<view class="right">
				<view class="top">
					...
					<view class="bottom">
						<view class="date w-line-1">2020.01.01-2020.01.31</view>
						<view class="immediate-use">立即使用</view>
					</view>
				</view>
				<view class="tips">
					<view class="explain">
						<w-icon name="zhuanfa" class="transpond" :size="24"></w-icon>
						<text>可赠送</text>
					</view>
				</view>
			</view>
			...
			<view class="ticket">
				<view class="left">
					...
					<view class="introduce">
						...
						<view class="date w-line-1">2019.11.28-2020.1.24</view>
					</view>
				</view>
				<view class="right">
	...
	.content {
		...
		.right {
			...
			.immediate-use {
				...
				border-radius: 25rpx;
				line-height: 50rpx;
				background-color: $w-type-warning!important;
...
.jingdong {
	...
	.right {
		...
		font-size: 28rpx;
		.top {
			border-bottom: 2rpx dashed $w-border-color;
			.title {
				margin-right: 60rpx;
				line-height: 40rpx;
				.tag {
		...
		.tips {
			...
			.particulars {
				...
				padding-top: 8rpx;
				border-radius: 50%;
				background-color: $w-type-info-disabled;
				text-align: center;
			}
		}
	}
