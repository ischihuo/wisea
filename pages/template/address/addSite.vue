<template>
	<view class="wrap">
		<view class="top">
			...
			<!-- <view class="site-clipboard">
				...
				<view class="clipboard">
					地址粘贴板
					<w-icon name="arrow-down" class="icon" :size="20"></w-icon>
				</view>
			</view> -->
		</view>
		<view class="bottom">
			<view class="tag">
				...
				<view class="right">
					...
					<view class="tags plus"><w-icon size="22" name="plus"></w-icon></view>
				</view>
			</view>
			<view class="default">
				<view class="left">
		...
		<w-picker mode="region" ref="uPicker" v-model="show" />
	</view>
</template>
...
.wrap {
	...
	.top {
		...
		border-top: solid 2rpx $w-border-color;
		padding: 22rpx;
		.item {
			display: flex;
			font-size: 32rpx;
		...
		.tag {
			...
			.right {
				...
				.tags {
					width: 140rpx;
					padding: 16rpx 8rpx;
					border: solid 2rpx $w-border-color;
					text-align: center;
					border-radius: 50rpx;
