		...
		<view class="comment">
			<view class="top">
				...
				<view class="right" :class="{ highlight: comment.isLike }">
					{{ comment.likeNum }}
					<w-icon v-if="!comment.isLike" name="thumb-up" class="like" color="#9a9a9a" :size="30" @click="getLike"></w-icon>
					<w-icon v-if="comment.isLike" name="thumb-up-fill" class="like" :size="30" @click="getLike"></w-icon>
				</view>
			</view>
				...
				<view class="comment">
					<view class="top">
						...
						<view class="right"  :class="{ highlight: item.isLike }">
							...
							<w-icon v-if="!item.isLike" name="thumb-up" class="like" :size="30" color="#9a9a9a" @click="getLike(index)"></w-icon>
							<w-icon v-if="item.isLike" name="thumb-up-fill" class="like" :size="30" @click="getLike(index)"></w-icon>
						</view>
					</view>
...
.all-reply {
	...
	.item {
		border-bottom: solid 2rpx $w-border-color;
	}
	.reply {
		padding: 20rpx;
