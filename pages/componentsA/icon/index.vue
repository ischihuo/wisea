<template>
	<view class="wrap">
		<view class="w-border-left w-border-top inner-wrap">
			<view @tap="selectIcon(item.name)" class="w-icon-item w-border-bottom w-border-right" v-for="(item, index) in iconList" :key="index">
				<w-icon :name="item.name" size="40" color="#909399"></w-icon>
				<text class="w-icon-name">{{item.name}}</text>
			</view>
		</view>
	</view>
</template>
