<template>
	<view class="w-divider" :style="{
		height: height == 'auto' ? 'auto' : height + 'rpx',
		backgroundColor: bgColor,
		marginBottom: marginBottom + 'rpx',
		marginTop: marginTop + 'rpx'
	}" @tap="click">
		<view class="w-divider-line" :class="[type ? 'w-divider-line--bordercolor--' + type : '']" :style="[lineStyle]"></view>
		<view v-if="useSlot" class="w-divider-text" :style="{
			color: color,
 ...
 * @example <w-divider color="#fa3534">长河落日圆</w-divider>
 */
export default {
	name: 'w-divider',
	props: {
