<template>
	<view class="w-countdown">
		<view class="w-countdown-item" :style="[itemStyle]" v-if="showDays && (hideZeroDay || (!hideZeroDay && d != '0'))">
			<view class="w-countdown-time" :style="[letterStyle]">
				{{ d }}
			</view>
		</view>
		<view
			class="w-countdown-colon"
		...
		<view class="w-countdown-item" :style="[itemStyle]" v-if="showHours">
			<view class="w-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ h }}
			</view>
		</view>
		<view
		...
		<view class="w-countdown-item" :style="[itemStyle]" v-if="showMinutes">
			<view class="w-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ i }}
			</view>
		</view>
		...
		<view class="w-countdown-item" :style="[itemStyle]" v-if="showSeconds">
			<view class="w-countdown-time" :style="{ fontSize: fontSize + 'rpx', color: color}">
				{{ s }}
			</view>
		</view>
 ...
 * @example <w-count-down ref="uCountDown" :timestamp="86400" :autoplay="false"></w-count-down>
 */
export default {
	name: 'w-count-down',
	props: {
