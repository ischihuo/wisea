<template>
	<view v-if="show" class="w-loading" :class="mode == 'circle' ? 'w-loading-circle' : 'w-loading-flower'" :style="[cricleStyle]">
	</view>
</template>
...
<script>
	 ...
	 * @example <w-loading mode="circle"></w-loading>
	 */
	export default {
		name: "w-loading",
		props: {
...
<style lang="scss" scoped>
	...
	.w-loading-circle {
		...
		animation: w-circle 1s linear infinite;
	}
	...
	.w-loading-flower {
		...
		animation: w-flower 1s steps(12) infinite;
