<template>
	<view class="w-slider" @tap="onClick" :class="[disabled ? 'w-slider--disabled' : '']" :style="{
		...
		>
			<view class="w-slider__button-wrap" @touchstart="onTouchStart" 
				@touchmove="onTouchMove" @touchend="onTouchEnd" 
				@touchcancel="onTouchEnd">
				<slot v-if="$slots.default"/>
				<view v-else class="w-slider__button" :style="[blockStyle, {
 ...
 * @example <w-slider v-model="value" />
 */
export default {
	name: 'w-slider',
	props: {
	...
	mounted() {
		// 获取滑块条的尺寸信息
		this.$wGetRect('.w-slider').then(rect => {
