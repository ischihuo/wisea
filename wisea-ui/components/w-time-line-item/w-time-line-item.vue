<template>
	<view class="w-time-axis-item">
		<slot name="content" />
		<view class="w-time-axis-node" :style="[nodeStyle]">
			<slot name="node">
				<view class="w-dot">
				</view>
			</slot>
...
<script>
	 ...
	 * @description 时间轴组件一般用于物流信息展示，各种跟时间相关的记录等场景。(搭配w-time-line使用)
	 ...
	 * @example <w-time-line-item node-top="2">...</w-time-line-item>
	 */
	export default {
		name: "w-time-line-item",
		props: {
			// 节点的背景颜色
			bgColor: {
				type: String,
