<template>
	<view class="w-waterfall">
		<view id="w-left-column" class="w-column"><slot name="left" :leftList="leftList"></slot></view>
		<view id="w-right-column" class="w-column"><slot name="right" :rightList="rightList"></slot></view>
	</view>
</template>
 ...
 * @example <w-waterfall :flowList="flowList"></w-waterfall>
 */
export default {
	name: "w-waterfall",
	props: {
	...
	methods: {
		async splitData() {
			...
			let leftRect = await this.$wGetRect('#w-left-column');
			let rightRect = await this.$wGetRect('#w-right-column');
